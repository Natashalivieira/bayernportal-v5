...
const config = {
  ...
  initialMessages: 
    [ createChatBotMessage(`Servus! Ich bin Bavaria. Freut mich, dich kennenzulernen! Lass mich wissen, wenn ich dir bei irgendetwas behilflich sein kann, indem du deine Frage oder ein Stichwort unten eingibst. Deine Eingaben werden selbstverständlich vertraulich behandelt.`),
